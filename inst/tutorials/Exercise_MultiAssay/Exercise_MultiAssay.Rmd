...
See the source code of the interactive exercises at https://github.com/waldronlab/MultiAssayWorkshop
...
The `experiments` function returns an `ExperimentList` object class that is part of the
`MultiAssayExperiment`. We will see how to get a more general `List` class shortly.
