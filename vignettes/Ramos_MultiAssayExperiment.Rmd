...
From the [@Chen2016-ba] publication of the [urcc_mskcc_2016][] study, we know
that the study used the `IMPACT230` gene panel, so we will specify that.
...
[urc_mskcc_2016]: https://www.cbioportal.org/study/summary?id=urcc_mskcc_2016
...
or sample types
* Functions such as `longForm` and `wideFormat` are helpful for downstream
