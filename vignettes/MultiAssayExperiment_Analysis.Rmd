---
title: "MultiAssayExperiment: Example Public-omic Analyses"
author:
  - name: Marcel Ramos
...
protein (RPPAArray), 2 are missing Mutations, 1 is missing gistict, 12 have
only mutations and gistict, etc.
...
miniACC2 <- c(miniACC2,
    ...
    gistictPCA = getLoadings(assays(miniACC2)[[2]], center=FALSE, scale.=FALSE),
    proteinPCA = getLoadings(assays(miniACC2)[[3]]),
    mutationsPCA = getLoadings(assays(miniACC2)[[4]], center=FALSE, scale.=FALSE),
