---
title: "MultiAssayExperiment & curatedTCGAData: Integrative workflow for Multi-omics data"
author:
  - name: Marcel Ramos
...
facilities made available by companion packages, `curatedTCGAData` and
`TCGAutils`, to work with TCGA data. Built using the
...
such as `SummarizedExperiment` and `RangedSummarizedExperiment`, which provide
...
| Activity                            | Time    |
|-------------------------------------|---------|
| Overview of key data classes and packages | 30m |
| Building a MultiAssayExperiment from scratch | 10m |
| curatedTCGAData multi-assay dataset | 20 min |
| TCGAutils functionality | 10m |
| Subsetting and reshaping multi-assay data | 20m |
| Plotting, correlation, analysis and other examples | 10m |
...
* use curatedTCGAData to create custom on-the-fly TCGA MultiAssayExperiment
objects
