...
* Browse to the [workshop website](https://waldronlab.io/MultiAssayWorkshop/)
...
Please use this citation [@Ramos2017-er] when using
`MultiAssayExperiment`, your citations are appreciated!
...
_Note_. many data classes that support row and column naming and subsetting
can be used in a `MultiAssayExperiment`.
...
_Note_. The `MultiAssayExperiment` package then provides functionality to
...
The [cBio Genomics Portal](https://www.cbioportal.org/) provides access to more
than 260 datasets collected and curated from different instutions.
...
Here we use the built-in visualization functionality to what extent the
samples in each assay overlap:
